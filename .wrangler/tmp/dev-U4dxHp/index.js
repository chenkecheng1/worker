...
// .wrangler/tmp/bundle-gvN7m4/checked-fetch.js
...
// .wrangler/tmp/bundle-gvN7m4/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/bundle-gvN7m4/middleware-loader.entry.ts
init_checked_fetch();
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();

// .wrangler/tmp/bundle-gvN7m4/middleware-insertion-facade.js
init_checked_fetch();
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
...
__name(isGraphQLSchema, "isGraphQLSchema");
...
var isLinkDirective = /* @__PURE__ */ __name((directive) => directive.name.value === "link", "isLinkDirective");
var getLinkDirectiveURL = /* @__PURE__ */ __name((directive) => {
...
function finalAsyncIterator(source, onFinal) {
  ...
  __name(ensureIterator, "ensureIterator");
  let isDone = false;
  return {
    [Symbol.asyncIterator]() {
      return this;
...
var executorFromSchema = memoize1(/* @__PURE__ */ __name(function executorFromSchema2(schema2) {
...
__name(useAllowedResponseHeaders, "useAllowedResponseHeaders");
...
__name(useAllowedRequestHeaders, "useAllowedRequestHeaders");
...
__name(removeDisallowedHeaders, "removeDisallowedHeaders");
...
__name(setObjectKeyPath, "setObjectKeyPath");
...
// src/index.js
var callOpenAI = /* @__PURE__ */ __name(async (prompt, env) => {
  console.log("env", env);
  const apiKey = env.OPENAI_API_KEY;
  if (!apiKey)
    throw new Error("OPENAI_API_KEY \u672A\u914D\u7F6E\uFF08wrangler secret put OPENAI_API_KEY\uFF09");
  const baseUrl = (env.OPENAI_BASE_URL ?? "https://api.openai.com/v1").replace(/\/$/, "");
  const target = `${baseUrl}/chat/completions`;
  const model = env.OPENAI_MODEL ?? "gpt-4o-mini";
  const systemPrompt = env.SYSTEM_PROMPT ?? "\u4F60\u662F\u4E00\u4E2A\u4E50\u4E8E\u52A9\u4EBA\u7684\u4E2D\u6587\u52A9\u624B\uFF0C\u8BF7\u4F7F\u7528\u7B80\u6D01\u7684\u4E2D\u6587\u56DE\u7B54\u3002";
